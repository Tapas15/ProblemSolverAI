...
async function addImageFields() {
  ...
  try {
    ...
    const frameworkImageMapping = [
      ...
      { id: 4, name: 'First Principles', image: 'https://images.unsplash.com/photo-1509869175650-a1d97972541a?q=80&w=500&auto=format&fit=crop' }, // First Principles - atomic elements
