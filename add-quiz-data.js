...
function getQuestionsForFramework(frameworkId, level) {
  const questions = {
    ...
    1: {
      ...
      advanced: [
        ...
        {
          id: 16,
          text: "How does systems thinking modify the application of MECE principles in organizational analysis?",
          options: [
            "Systems thinking replaces MECE when analyzing organizations",
            "MECE is used to categorize components while systems thinking addresses relationships between categories",
            "Systems thinking and MECE cannot be reconciled due to fundamental differences",
            "MECE should be applied before systems thinking to establish clear categories"
          ],
          correctAnswer: 1
        },
        {
          id: 17,
          text: "What is the most sophisticated approach to ensuring that a MECE framework remains relevant in rapidly changing business environments?",
          options: [
            "Creating very broad categories that won't need to change",
            "Focusing on fundamental business principles rather than current conditions",
            "Designing flexible, multi-level frameworks where lower levels can be updated as conditions change",
            "Avoiding long-term use of any single framework"
          ],
          correctAnswer: 2
        }
      ]
    ...
    3: {
      ...
      intermediate: [
        ...
        {
          id: 11,
          text: "In a TOWS strategic alternatives matrix, what does an 'ST strategy' refer to?",
          options: [
            "Using strengths to minimize threats",
            "Strengthening the organization against threats",
            "Strategic targeting of market segments",
        ...
        {
          id: 12,
          text: "What role should data play in SWOT analysis?",
          options: [
            "SWOT should be purely qualitative with no data requirements",
            "SWOT factors should be supported by relevant data whenever possible",
            "Only 'strengths' and 'weaknesses' require data validation",
            "SWOT should exclusively use quantitative data"
          ],
          correctAnswer: 1
        }
      ],
      advanced: [
        ...
        {
          id: 16,
          text: "How might a company integrate design thinking principles with SWOT analysis?",
          options: [
            "Replace SWOT with design thinking methodologies",
            "Use empathy mapping to enhance understanding of external factors (opportunities and threats)",
            "Add a fifth 'User Experience' quadrant to the traditional SWOT",
            "Apply design thinking only after completing the SWOT"
          ],
          correctAnswer: 1
        },
        {
          id: 17,
          text: "What is the most sophisticated approach to addressing the criticism that SWOT lacks quantitative rigor?",
          options: [
            "Replace SWOT with purely quantitative methodologies",
            "Integrate SWOT with weighted scoring systems and targeted metrics for key factors",
            "Use SWOT only for qualitative factors and different tools for quantitative analysis",
            "Add numerical rankings to each SWOT factor"
          ],
          correctAnswer: 1
        }
      ]
    ...
    5: {
      ...
      intermediate: [
        ...
        {
          id: 11,
          text: "What role does First Principles thinking play in system design?",
          options: [
            "It's not relevant to system design",
            "It helps designers copy existing successful systems",
            "It allows designers to understand fundamental requirements before creating solutions",
            "It encourages designers to focus on aesthetics rather than functionality"
          ],
          correctAnswer: 2
        },
        {
          id: 12,
          text: "How might a leader encourage First Principles thinking in their team?",
          options: [
            "By providing detailed solutions to problems",
            "By rewarding adherence to established procedures",
            "By consistently challenging assumptions and asking 'why'",
            "By emphasizing speed over thoroughness"
          ],
          correctAnswer: 2
        }
      ],
      advanced: [
        ...
        {
          id: 16,
          text: "What is the relationship between First Principles thinking and the 'jobs to be done' theory?",
          options: [
            "They are competing frameworks that should not be used together",
            "Jobs to be done focuses on customers while First Principles applies to internal operations",
            "Both approaches seek to identify fundamental needs rather than surface-level wants",
            "Jobs to be done is a more practical framework while First Principles is more theoretical"
          ],
          correctAnswer: 2
        },
        {
          id: 17,
          text: "How might a company apply First Principles thinking to their approach to talent management?",
          options: [
            "By implementing industry standard HR practices",
            "By questioning fundamental assumptions about what motivates people and how work should be organized",
            "By focusing talent management on high-performing individuals",
            "By standardizing talent processes across the organization"
          ],
          correctAnswer: 1
        }
      ]
  ...
  // Add default questions for other frameworks if specific ones aren't defined
